...
const styles = {
  ...
  hero: { position: 'relative', minHeight: '85vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem 2rem 8rem', zIndex: 10 },
  ...
  headlineLine2: { display: 'flex', alignItems: 'center', justifyContent: 'center', height: 'clamp(3rem, 6vw, 5rem)' },
  typingContainer: { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 'clamp(260px, 55vw, 420px)' },
  typingText: { fontSize: 'clamp(2rem, 4vw, 3.5rem)', fontWeight: '700', color: '#FF6B35', whiteSpace: 'nowrap', fontFamily: "'Space Grotesk', 'Courier New', monospace", textAlign: 'center', width: '100%' },
