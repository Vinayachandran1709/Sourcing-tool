        ...
        <div style={styles.container}>
          ...
          <div style={styles.featureGrid}>
            <div style={styles.featureCard}>
              ...
              <h3 style={styles.featureTitle}>Smart GitHub Search</h3>
              <p style={styles.featureDesc}>Go beyond GitHub's 30-result limit. Our AI breaks down complex queries to find 300+ relevant developers per search.</p>
            </div>
            <div style={styles.featureCard}>
            ...
            <div style={styles.featureCard}>
              ...
              <h3 style={styles.featureTitle}>Growing Database</h3>
              <p style={styles.featureDesc}>Every search enriches our database. Access previously discovered developers instantly without new API calls.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={styles.container}>
          ...
          <div style={styles.stepsGrid}>
            <div style={styles.step}>
              ...
              <p style={styles.stepDesc}>Enter your requirements - skills, location, experience level. Our AI handles the rest.</p>
            </div>
            <div style={styles.stepArrow}>→</div>
            <div style={styles.step}>
              <div style={styles.stepNumber}>2</div>
              <h3 style={styles.stepTitle}>Review</h3>
              <p style={styles.stepDesc}>Browse scored profiles with detailed insights on each developer's work and expertise.</p>
            </div>
            <div style={styles.stepArrow}>→</div>
            <div style={styles.step}>
              <div style={styles.stepNumber}>3</div>
              <h3 style={styles.stepTitle}>Reach Out</h3>
              <p style={styles.stepDesc}>Send personalized emails directly from TalentBox. Track opens, clicks, and responses.</p>
            </div>
          </div>
        </div>
      </section>
...
const styles = {
  ...
  heroTitle: { fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: '700', color: '#1a1a1a', marginBottom: '1.5rem', lineHeight: '1.2', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: '0.5rem' },
  titleLine: { whiteSpace: 'nowrap' },
  typingWrapper: { display: 'inline-flex', alignItems: 'center', minWidth: '340px', justifyContent: 'flex-start' },
